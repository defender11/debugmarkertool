...
const debugMarkerTool = {
  ...
  updateMarker: function (params) {
    ...
    if ((typeof params.html !== undefined) && params.html !== '') {
      ...
      if (params.left) {
        $html += ' <div style="position: absolute; top: 0; left: ' + params.left + '; width: 1px; height: ' + $('body').outerHeight() + 'px; z-index: 9999;background-color: #00d0ff;">' +
          '<span style="position: absolute; top: 0; left: 0; color: white; background-color: #333333; padding: 8px;">Left: ' + params.left + '</span>' +
          '</div>';
      }
